        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Ingresa el nombre del usuario" value="{{old('name', $usuario->name)}}">
                    @error('name')
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Ingresa el correo electrónico del usuario" value="{{old('email', $usuario->email)}}">
                    @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('age') is-invalid @enderror" id="age" name="age" placeholder="Ingresa la edad del usuario" value="{{old('age', $usuario->age)}}">
                    @error('age')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('position') is-invalid @enderror" id="position" name="position" placeholder="Ingresa el cargo laboral del usuario" value="{{old('position', $usuario->position)}}">
                    @error('position')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
